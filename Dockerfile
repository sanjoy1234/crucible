...
LABEL description="CRUCIBLE — Adversarial Co-Generation Engine"
...
RUN mkdir -p .crucible/reports .crucible/forge .crucible/brain

# Non-root user for security
RUN useradd --create-home crucible
