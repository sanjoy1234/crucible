"""
Policy Hub — crucible policy install <domain>

Downloads community policy playbooks from the GitHub-backed Policy Hub index
and installs them into the project-local `.crucible/policies/` directory.

Index URL: https://raw.githubusercontent.com/sanjoy1234/crucible/main/policy-hub/index.json
...
_HUB_INDEX_URL = (
    "https://raw.githubusercontent.com/sanjoy1234/crucible/main/policy-hub/index.json"
)
_LOCAL_POLICIES_DIR = Path(".crucible/policies")
...
def install_domain(
    ...
    Args:
        ...
        policies_dir: Local directory to install into (default: .crucible/policies/)
