"""Run command — programmatic API for crucible run."""
...
async def execute(
    ...
    """
    Execute a full CombatPair adversarial session.
    ...
    Args:
        ...
        config_path: Path to .crucible.yml (None = auto-detect)
    ...
    cfg.combat_pair.attack_count = mode_counts.get(mode, 20)
