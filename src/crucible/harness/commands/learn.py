...
def execute(run_id: str, config_path: str | None = None) -> LearnResult:
    ...
    from crucible.output.report import load_report
    from crucible.memory.forge import KnowledgeForge
    from crucible.memory.tagger import tag_attack, tags_to_metadata
    from crucible.brain.effectiveness import AttackEffectivenessTracker
