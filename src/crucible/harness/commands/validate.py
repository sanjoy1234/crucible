"""Validate command — programmatic API for crucible validate + AVF gate."""
...
async def execute(
    ...
    from crucible.policy.engine import list_available_domains

    cfg = CrucibleConfig.load(config_path)
    checks: list[CheckResult] = []
    all_passed = True

    checks.append(CheckResult("Config loaded", True, ".crucible.yml"))
