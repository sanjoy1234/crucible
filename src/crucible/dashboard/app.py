...
<title>CRUCIBLE — System Status</title>
<style>
...
<html lang="en"><head><meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>CRUCIBLE — JSON API Reference</title>
<style>
...
<header>
  <h1>&#x26A4; CRUCIBLE &mdash; JSON API Reference</h1>
...
<div class="ep">
  ...
  <div class="desc">Raw health check. Returns <code>{{"status":"ok","service":"crucible-dashboard"}}</code>. Used by load balancers and monitoring systems.</div>
...
<html lang="en"><head><meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>CRUCIBLE — MCP Tools</title>
<style>
*{{box-sizing:border-box;margin:0;padding:0}}
...
<header>
  <h1>&#x1F9E0; CRUCIBLE &mdash; MCP Tools</h1>
  <p>{len(tools)} tools available &nbsp;&bull;&nbsp; Works with Claude Code, Cursor, Windsurf, GitHub Copilot, Codex</p>
</header>
<div class="body">
<a class="back" href="/">&#x2190; Back to Dashboard</a>
<div class="intro">
  <strong>Model Context Protocol (MCP)</strong> lets your AI coding assistant call CRUCIBLE directly from chat.
  Run <code style="background:#EFF6FF;padding:2px 6px;border-radius:4px;font-size:12px">crucible integrate</code> to wire it up automatically,
  ...
  The stdio transport (<code style="background:#EFF6FF;padding:2px 6px;border-radius:4px;font-size:12px">crucible mcp-server</code>) is recommended for local development.
</div>
{cards_html}
</div></body></html>"""
        return HTMLResponse(html)
...
def _load_active_runs(runs_dir: Path) -> list[dict]:
    ...
    liveness check `crucible status` uses, so the dashboard and CLI always agree."""
...
def _render_index(reports: list[dict], cfg: CrucibleConfig, active_runs: list[dict] | None = None) -> str:
    ...
    empty_html = "" if reports else (
        ...
        '<code class="empty-cmd">crucible run --issue examples/demo_issue.md --pretty</code>'
        '</div>'
    )
    table_html = ""
    if reports:
...
<div class="hero">
  <div class="hero-inner">
    ...
    <div class="hero-text">
      ...
      <p>CRUCIBLE generates <strong>code and attacks simultaneously</strong> — the Builder writes,
...
<div class="pipeline-card">
  <div class="card-hdr">&#x26A1; How CRUCIBLE Works &mdash; Live Pipeline</div>
...
<div class="cli-card">
  <div class="cli-hdr">
    ...
    <span class="cli-title">Terminal &mdash; CRUCIBLE CLI Quick Start</span>
  </div>
  <div class="cli-body">
    <div class="cli-block">
      <div class="cli-block-title">&#x1F680; Run adversarial testing</div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">crucible run</span> <span class="cli-flag">--issue</span> <span class="cli-arg">examples/demo_issue.md</span> <span class="cli-flag">--pretty</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">crucible run</span> <span class="cli-flag">--issue</span> <span class="cli-arg">https://github.com/org/repo/issues/42</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">crucible run</span> <span class="cli-flag">--issue</span> <span class="cli-arg">./src/</span> <span class="cli-flag">--intent</span> <span class="cli-arg">PROJ-123</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">crucible run</span> <span class="cli-flag">--rounds</span> <span class="cli-arg">3</span> <span class="cli-flag">--format</span> <span class="cli-arg">sarif</span></span></div>
    </div>
    <div class="cli-block">
      <div class="cli-block-title">&#x1F527; Setup &amp; Integration</div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">crucible integrate</span> <span class="cli-arg">all</span> <span class="cli-comment"># Claude Code, Cursor, Copilot, Codex, Windsurf</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">crucible integrate</span> <span class="cli-arg">github-actions</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">crucible findings</span> <span class="cli-comment"># last run vulnerability report</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">crucible dashboard</span> <span class="cli-flag">--port</span> <span class="cli-arg">8080</span> <span class="cli-comment"># this UI</span></span></div>
    </div>
    <div class="cli-block">
      <div class="cli-block-title">&#x1F4E6; Multi-repo testing</div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">crucible run</span> <span class="cli-flag">--issue</span> <span class="cli-arg">https://github.com/axios/axios</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">crucible run</span> <span class="cli-flag">--issue</span> <span class="cli-arg">https://github.com/pallets/flask</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">crucible run</span> <span class="cli-flag">--issue</span> <span class="cli-arg">https://github.com/gin-gonic/gin</span></span></div>
    </div>
    <div class="cli-block">
      <div class="cli-block-title">&#x1F3C6; Output formats</div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">crucible run</span> <span class="cli-flag">--format</span> <span class="cli-arg">html</span> <span class="cli-comment"># exec report</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">crucible run</span> <span class="cli-flag">--format</span> <span class="cli-arg">sarif</span> <span class="cli-comment"># SAST tools</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">crucible run</span> <span class="cli-flag">--format</span> <span class="cli-arg">junit</span> <span class="cli-comment"># CI pipelines</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">crucible findings</span> <span class="cli-flag">--format</span> <span class="cli-arg">md</span> <span class="cli-comment"># PR comment</span></span></div>
    </div>
  </div>
</div>

</div><!-- /main -->
<footer>CRUCIBLE Adversarial Co-Generation Engine &nbsp;&bull;&nbsp; Built by Sanjoy Ghosh &nbsp;&bull;&nbsp; Auto-refreshes every 30s</footer>
