...
Enriches the CRUCIBLE Breaker with live CVE intelligence from NIST's
...
class NvdClient:
    ...
    intelligence context for the CRUCIBLE Breaker agent.

    All calls are best-effort — a network failure or API error never
    blocks a CRUCIBLE run; the Breaker simply runs without live NVD context.
    """
