...
Enriches the CRUCIBLE Breaker with CISA's authoritative feed of vulnerabilities
...
The feed is cached for the duration of a CRUCIBLE process — it's a ~4MB JSON
...
class KevClient:
    ...
    relevant to the current CRUCIBLE run. Returns formatted Breaker context.
