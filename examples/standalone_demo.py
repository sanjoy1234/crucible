#!/usr/bin/env python3
"""
CRUCIBLE standalone demo — no installation required beyond the package itself.
...
from crucible.core.combat_pair import CombatPair
from crucible.core.arbiter import Arbiter
from crucible.output.report import build_report, generate_run_id, render_markdown, save_report
from crucible.brain.fingerprint import fingerprint_spec
