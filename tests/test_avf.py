...
from crucible.harness.commands.validate import _hits_fixture, _run_avf_gate
...
async def test_avf_gate_passes_with_mock_hits():
    ...
    from crucible.agents.breaker import BreakerResult, Attack
    from crucible.agents.base import ModelResponse
    ...
    with patch("crucible.agents.breaker.Breaker.attack", new=mock_attack):
...
async def test_avf_gate_fails_when_no_attacks_found():
    ...
    from crucible.agents.breaker import BreakerResult
    from crucible.agents.base import ModelResponse
