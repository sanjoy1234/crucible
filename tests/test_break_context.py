...
from crucible.core.break_context import (
    compress_target,
...
def test_breaker_has_break_context_enabled_attribute():
    from crucible.agents.breaker import Breaker
...
def test_config_break_context_enabled_default():
    from crucible.config import CombatPairConfig
