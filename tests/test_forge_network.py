...
from crucible.network.forge_network import (
    ForgeNetworkConfig,
    SharedPattern,
    NetworkResult,
    push_patterns,
...
def test_network_config_from_env_enabled(monkeypatch):
    monkeypatch.setenv("CRUCIBLE_FORGE_NETWORK_ENABLED", "true")
    monkeypatch.setenv("CRUCIBLE_FORGE_HUB_URL", "http://hub.local")
    monkeypatch.setenv("CRUCIBLE_FORGE_MIN_ARS", "0.90")
