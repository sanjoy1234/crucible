...
from crucible.brain.language_profiles import (
    get_profile,
...
from crucible.brain.fingerprint import fingerprint_spec, _detect_language
...
def test_cwe_taxonomy_includes_prototype_pollution():
    ...
    taxonomy_path = Path(__file__).parent.parent / "src" / "crucible" / "data" / "cwe_taxonomy.json"
