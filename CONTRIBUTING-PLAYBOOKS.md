# Contributing Playbooks to CRUCIBLE
...
extends CRUCIBLE's coverage to a new compliance domain.

---

## Playbook Schema

Each playbook is a YAML file in `src/crucible/policy/domains/`. The schema:
...
```bash
crucible policy:validate --file src/crucible/policy/domains/your_domain.yaml
```
...
2. Create your playbook at `src/crucible/policy/domains/<name>.yaml`
3. Run `crucible policy:validate --file <path>`
